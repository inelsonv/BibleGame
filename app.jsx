        ...
        <div className="font-ui" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14, flexWrap: "wrap", gap: 8 }}>
          ...
          <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <select
              ...
              style={{ background: "#0F1A2E", color: "#F5EFE0", border: "1.5px solid #3A5578", borderRadius: 7, padding: "6px 10px", fontSize: 13.5 }}
            >
              {library.map((b) => (
                      ...
                      {editState.opts.map((o, idx) => (
                        <div key={idx} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                          <button
                            ...
                            className="font-display"
                            style={{
                              width: 30, height: 30, borderRadius: 7, flex: "0 0 auto", cursor: "pointer",
  ...
  return (
    <div style={styles.container} className="fade-in">
      ...
      <div style={styles.scoreBar}>
        ...
        <div className="font-ui" style={{ textAlign: "center", color: "#B8A98A", fontSize: 12.5 }}>
          <div style={{ color: "#B8892B", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em" }}>{book?.name}</div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        display: "flex", alignItems: "center", justifyContent: "center",
        fontFamily: "'Cinzel', serif", fontWeight: 700, color: "#F5EFE0", fontSize: 16,
        boxShadow: active ? `0 0 0 3px #16233D, 0 0 0 5px ${color}` : "none",
      }}>
        {score}
      </div>
      <div className="font-ui" style={{ fontSize: 13.5, color: "#F5EFE0", fontWeight: 600, maxWidth: 110, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
        {name}
      </div>
    </div>
  );
...
const styles = {
  ...
  h1: { fontSize: "clamp(28px, 5vw, 40px)", color: "#F5EFE0", margin: "14px 0 8px", fontWeight: 700 },
  subtitle: { color: "#B8A98A", fontSize: 16, maxWidth: 440, margin: "0 auto" },
  ...
  bookGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 14, marginTop: 28 },
  bookCard: {
    display: "flex", alignItems: "center", gap: 14, textAlign: "left",
    background: "linear-gradient(180deg, #1A2C48 0%, #16233D 100%)",
    border: "1.5px solid #3A5578", borderRadius: 12, padding: "16px 18px", cursor: "pointer",
  },
  bookDropcap: {
    width: 44, height: 44, borderRadius: 8, background: "rgba(184,137,43,0.15)",
    border: "1.5px solid #B8892B", color: "#B8892B", fontSize: 22,
    display: "flex", alignItems: "center", justifyContent: "center", flex: "0 0 auto",
  },
  scoreBar: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 },
  ...
  questionCard: {
    background: "linear-gradient(180deg, #1A2C48 0%, #16233D 100%)",
    border: "1.5px solid #3A5578", borderRadius: 16, padding: "26px 24px",
  },
  questionText: { fontSize: 22, color: "#F5EFE0", lineHeight: 1.4 },
  ...
  verseToast: {
    ...
    width: "min(92vw, 620px)", zIndex: 60,
    background: "linear-gradient(180deg, #1A2C48 0%, #12203A 100%)",
    border: "2px solid #B8892B", borderRadius: 18, padding: "34px 36px",
